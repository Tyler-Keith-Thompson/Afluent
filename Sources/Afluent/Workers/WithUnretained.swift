...
extension AsynchronousUnitOfWork {
    ...
    public func withUnretained<Object: AnyObject & Sendable, Out: Sendable>(_ obj: Object, resultSelector: @Sendable @escaping (Object, Success) -> Out) -> some AsynchronousUnitOfWork<Out> {
